...
description: |
  Vous trouverez ici un récapitulatif de tous les projets réalisés en lien avec le métier d' administrateur systèmes, réseaux et sécurité.
tags:
  - Rigueur
  - Réactivité
  - Curiosité technique
...
### 12 : Gérer une migration vers le cloud
...
### 11 : Évaluer et améliorer le niveau de sécurité d'un domaine Windows et de l'Active Directory associé
...
### 10 : Sécuriser le réseau d'une grande entreprise
Dans ce projet, j'ai été chargé de migrer une application de sécurisation des données vers le cloud pour Nimbus Corp, afin de pallier les limites de capacité des serveurs et l'obsolescence du système d'exploitation. Mon rôle a consisté à effectuer une veille technologique, concevoir un plan de migration, et améliorer la performance de l'infrastructure IT tout en maîtrisant les coûts. Cela m'a permis de renforcer mes compétences en gestion de projet et en modernisation des infrastructures IT.
...
### 09 : Mettre en place une nouvelle solution de sauvegarde
...
### 08 : Gérer le parc informatique d'une PME
...
### 07 : Superviser le SI d'une entreprise
...
### 06 : Configurer des services réseaux et des équipements d'interconnexion
...
### 05 : Raccorder une entité et ses postes de travail au SI de votre entreprise
...
### 04 : Mettre en place des services web sécurisés
...
### 03 : Déployer une architecture n-tiers pour une PME
...
### 02 : Mettre en place et documentez le réseau local d'une startup
...
### 01 : Gérer les demandes au quotidien
